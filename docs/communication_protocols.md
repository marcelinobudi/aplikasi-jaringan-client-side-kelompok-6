...
Client
```text
REQUEST STRING_WITHOUT_VOWELS $TEXT
```
...
Client
```text
REQUEST DETERMINAN_AND_INVERSE_MATRIX $a[0][0] $a[0][1] $a[0][2] $a[1][0] $a[1][1] $a[1][2] $a[2][0] $a[2][1] $a[2][2]
```
